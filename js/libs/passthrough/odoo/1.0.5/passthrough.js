...
function getNewLink(old_href, urlParams) {
    ...
    if (trkParams === undefined) trkParams = {};
    if (dsgParams === undefined) dsgParams = {};
    if (link_trkParams === undefined) link_trkParams = {};
    if (link_dsgParams === undefined) link_dsgParams = {};
...
function checkRequiredParams() {
    ...
    if (!url_fbp && fbParams.fbp) {
        ...
        console.log("fbp found and added to url");
        updated = true;
    }
    if (!url_fbc && fbParams.fbc) {
        urlParams.set('fbc', fbParams.fbc);
        console.log("fbc found and added to url");
        updated = true;
    }
    if (fbclid && !fbParams.fbc) {
        ...
        console.log("fbc not found but created from fbclid and added to url");
    ...
    if (!urlParams.has('utm_source') && !urlParams.has('passthrough[utm_source]')) {
        if (referer) {
            ...
            urlParams.set('utm_source', 'Direct_Search');
        }
    }
...
function waitForFbCookiesAndUpdateURL() {
